...
$sql="SELECT vak.naam, vak.code, vak.taal, student.voornaam, student.achternaam, student.studentennummer
FROM vak
RIGHT JOIN .vakstudent ON vak.code=vakstudent.vakcode
INNER JOIN student ON vakstudent.studentennummer=student.studentennummer";
