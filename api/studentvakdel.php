...
if(!$stmt = $conn->prepare("DELETE FROM vakstudent WHERE studentennummer = ? AND vakcode = ?")){
...
if(!$stmt -> bind_param("ii", htmlentities($postvars['student_nummer']), $postvars['student_vak'])){
